...
| `lib.stdlib` | foundation | Typed imports cover allocation plus `atoi`/`atol` string conversions; the remainder of the conversion, process, sorting and searching surface remains pending. |
